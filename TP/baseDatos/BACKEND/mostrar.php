...
<table align=\"center\" style='border-collapse:collapse;'>
    ...
    if($cursor->rowCount()){
        while($user = $cursor->fetch(PDO::FETCH_OBJ)){
            ...
            echo "<td><input type='button' value='Eliminar' onClick='EliminarEmpleado(" . $user->legajo . ")' /></td>";
            echo "<td><input type='button' value='Modificar' onClick='ModificarUsuario(" . $user->dni . ")' /></td></tr>";
        }
    }
